...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    screenshots: [
      {
        src: "/projects/Snag/login_screen.png",
        caption:
      ...
      {
        src: "/projects/Snag/wishlist.png",
        caption:
      ...
      {
        src: "/projects/Snag/activity.png",
        caption:
  ...
  // --- Archived projects (hidden from the curated page; uncomment to restore) ---
  /*
  {
